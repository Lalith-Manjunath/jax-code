...
import numpy as np
from codebase.utils import common
from codebase.utils import registry
from codebase.utils import tokenization
import codebase.utils.lm_format as lm_format_lib


DATASETS_DIR = os.getenv('JAX_DATASETS', os.path.expanduser('/mnt/d/Code/jax-code/.cache/datasets/'))
VOCABS_DIR = os.getenv('JAX_VOCABS', os.path.expanduser('/mnt/d/Code/jax-code/.cache/vocabs/'))
